...
public class PHADataFixer5 {
	...
	*/
	...
	public PHADataFixer5(String[] args) {
		try {
			numIntervals = 0;
			numTotalBins = 0;
			...
			file out = new file("phadataRawFluxes.dat");
			out.initWrite(false);
...
*/
	...
	public static final void main(String[] args) {
		PHADataFixer5 pdf4 = new PHADataFixer5(args);
	}
}
