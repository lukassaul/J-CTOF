...
*
*/
public class FluxDataInterpolator {

	public static int NUM_LINES = 13331;
	public float[][] data;
	public int[] dates;
	/**
	...
	*/
	public FluxData[] getData(int date) {
		...
		/*   here's constructor for reference
