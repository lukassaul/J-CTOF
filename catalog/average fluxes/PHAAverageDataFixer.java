...
/**
*  Lets generate sliding average flux histogram data
*
*
*
*
...
*
*/
public class PHAAverageDataFixer {
	...
	*/
	...
	public static int DELTAT = 3600; // sliding average time
	...
	public PHAAverageDataFixer(String[] args) {
		try {
			...
			//sr = new SWDataInterpolator("pm_data.dat",46145);
			...
			for (int d=startDate; d<=finishDat; d+= SDELTAT) {
				// reset arrays
