...
*/
public class ElectronParameterReader {
	...
	*
	*/
	public ElectronParameterReader (String fileName) {
		file f1 = new file(fileName);
		NUM_LINES = f1.readShitNumLines();
		StringTokenizer st;
		...
		f.closeRead();
		System.out.println("Loaded Electron Data " + i);
